  ...
  switch (action.type) {
    case DEF.OWN_INFO.SETTING:
      return {
        ...
        repeatInterval: Number(action.setting.repeatInterval),
        repeatCnt: Number(action.setting.repeatCnt),
    ...
    case DEF.OWN_INFO.EDIT_SETTING:
      return {
        ...
        repeatInterval: action.ownInfo.repeatInterval,
        repeatCnt: action.ownInfo.repeatCnt,
